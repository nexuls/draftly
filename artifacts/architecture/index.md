...
| Document                                           | Covers                                                                                                                                                                                                                                                         | Open it when                                                           |
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **[build-and-tooling.md](./build-and-tooling.md)** | Bun/Turborepo/tsup toolchain, every command, the task graph, the library build and why CodeMirror is external, the `draftly/src` raw-TS export, Prettier/ESLint config, the Changesets release flow, the **absent test suite**, and the vendored agent skills. | Running or changing a build, shipping a release, or setting up tooling |
