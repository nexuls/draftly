# T-012 — Remove document positions from widget `eq()`
...
- [ ] Typing above a mermaid diagram does not re-render it (no loading flash)
- [ ] Typing above a KaTeX formula does not re-render it
- [ ] Typing above an image does not cause visible flicker
- [ ] Clicking a widget after edits above it still selects the correct raw markdown range
- [ ] Widget click behaviour unchanged in all other respects
- [ ] Cursor entering a construct still retracts the widget and reveals raw syntax
